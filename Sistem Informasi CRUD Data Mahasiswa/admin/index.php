...
<nav class="navbar navbar-default">
		  <div class="container">	
				<h3 id="brand"><a href="index.php">DAFTAR NILAI UJIAN NASIONAL SMPN 1 KARAWANG</a></h3>
				<ul>
...
<table class="table table-hover" align="center" cellpadding="10" cellspacing="0" width="75%">
	...
	<tr>
		...
		<td><?= $row["indo"]; ?></td>
		<td><?= $row["ing"]; ?></td>
		<td><a class="btn btn-primary" href="ubah.php?id= <?= $row["nis"]; ?>">Ubah</a></td>
		<td><a class="btn btn-danger" href="hapus.php?id= <?= $row["nis"]; ?>" onclick="return confirm('Yakin?');">Hapus</a></td> 
	</tr>
	<?php $i++; ?>
	<?php endforeach; ?>
</table><br><br>
